...
mod tests {
    ...
    const TEST_CASES: &[(&str, &str)] = &[
        ...
        ("@####", "WqzBKA=="),
        ("0", ""),
        ("深心托豪素,怀抱观古今", "/DhT7g4dWo/+iV6oScyAPMtykWeYW34bCcaYzQ=="),
        ("境外势力", "/y1h7hUIWYzZhGWZ"),
        ("信息化数字化智能化", "/jBD7TAxWYrwh3qyS9W39aFk9xioAhUB"),
        ("Talk is cheap, show me the code", "Tu6OYJH3zyYFCYpj3lQAY0WdZqF/j7bI40Y3Cg=="),
    ];
